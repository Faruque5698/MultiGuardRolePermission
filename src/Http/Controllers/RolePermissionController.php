...
namespace FaruqueAshad\MultiGuardRolePermission\Http\Controllers;
...
use FaruqueAshad\MultiGuardRolePermission\Models\UserRole;
...
class RolePermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        if (is_array($params) && isset($params['search']) && $params['search']) {
            $data = $data->where('roles.name', 'like', '%' . $params['search'] . '%');
        }

        if (is_array($params) && isset($params['guard']) && $params['guard']) {
